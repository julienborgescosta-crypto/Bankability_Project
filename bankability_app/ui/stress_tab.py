...
def render(inputs: ProjectInputs, debt_kwargs: dict) -> None:
    ...
    display = df.rename(columns={"revenue_case": "Revenue", "degradation_case": "Dégradation", "combined": "Stress combiné"})
    st.dataframe(
        display[["Revenue", "Dégradation", "Stress combiné", "Project IRR", "Equity IRR", "DSCR min"]],
        hide_index=True,
